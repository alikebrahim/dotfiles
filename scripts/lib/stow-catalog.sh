...
stow_catalog_register quickshell "Quickshell" desktop "Omarchy-derived X11 shell configuration"
...
stow_catalog_register flameshot "Flameshot" desktop "X11 screenshot tool configuration"
